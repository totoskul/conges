...
class CronTask extends \AppBundle\Entity\CronTask implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CronTask' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CronTask' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\CronTask' . "\0" . 'commands', '' . "\0" . 'AppBundle\\Entity\\CronTask' . "\0" . 'interval', '' . "\0" . 'AppBundle\\Entity\\CronTask' . "\0" . 'lastrun');
        }
