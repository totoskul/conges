 ...
 */
class LeaveRequest extends \AppBundle\Entity\LeaveRequest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\LeaveRequest' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\LeaveRequest' . "\0" . 'dateProposal', '' . "\0" . 'AppBundle\\Entity\\LeaveRequest' . "\0" . 'dateResult', '' . "\0" . 'AppBundle\\Entity\\LeaveRequest' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\LeaveRequest' . "\0" . 'leaveType');
        }
