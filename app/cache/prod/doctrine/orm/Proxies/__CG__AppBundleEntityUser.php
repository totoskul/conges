...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'serial', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'arrival', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'departure', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'userLeaveMonths', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'contractType', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addUserLeaveMonth(\AppBundle\Entity\UserLeaveMonth $userLeaveMonths)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addUserLeaveMonth', array($userLeaveMonths));

        return parent::addUserLeaveMonth($userLeaveMonths);
    }
    ...
    public function removeUserLeaveMonth(\AppBundle\Entity\UserLeaveMonth $userLeaveMonths)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeUserLeaveMonth', array($userLeaveMonths));

        return parent::removeUserLeaveMonth($userLeaveMonths);
    }
    ...
    public function getUserLeaveMonths()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserLeaveMonths', array());

        return parent::getUserLeaveMonths();
    }
    ...
    public function setContractType(\AppBundle\Entity\ContractType $contractType = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setContractType', array($contractType));

        return parent::setContractType($contractType);
    }
    ...
    public function getContractType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContractType', array());

        return parent::getContractType();
    }
