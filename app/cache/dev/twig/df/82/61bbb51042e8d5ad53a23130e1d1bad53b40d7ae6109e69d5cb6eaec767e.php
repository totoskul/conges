...
\t\t\t";
                    ...
                    if (($this->getAttribute($context["entityBis"], "year", array()) ==  -1)) {
                        // line 46
                        echo "\t\t\t\t";
                        $context["nbN1"] = (((isset($context["nbN1"]) ? $context["nbN1"] : $this->getContext($context, "nbN1")) + $this->getAttribute($context["entityBis"], "nbAvailable", array())) - $this->getAttribute($context["entityBis"], "nbUsed", array()));
                        // line 47
                        echo "\t\t\t";
                    } else {
                        // line 48
                        echo "\t\t\t\t";
                        $context["nbN"] = (((isset($context["nbN"]) ? $context["nbN"] : $this->getContext($context, "nbN")) + $this->getAttribute($context["entityBis"], "nbAvailable", array())) - $this->getAttribute($context["entityBis"], "nbUsed", array()));
                        // line 49
                        echo "\t\t\t";
                    }
                    // line 50
            ...
            // line 52
            echo "\t";
            if (($this->getAttribute($context["entity"], "nbDays", array()) > (isset($context["nbN1"]) ? $context["nbN1"] : $this->getContext($context, "nbN1")))) {
                // line 53
                echo "\t\t";
...
\t<p><b>Congés disponibles (N) si validation : </b>";
                // line 85
                echo twig_escape_filter($this->env, (isset($context["nbN"]) ? $context["nbN"] : $this->getContext($context, "nbN")), "html", null, true);
                echo "</p>
\t<p><b>Congés disponibles (N-1) si validation : </b>";
                // line 86
                echo twig_escape_filter($this->env, (isset($context["nbN1"]) ? $context["nbN1"] : $this->getContext($context, "nbN1")), "html", null, true);
                echo "</p>
\t";
                // line 87
                if ((((isset($context["alertM1"]) ? $context["alertM1"] : $this->getContext($context, "alertM1")) == 1) && ($this->getAttribute($this->getAttribute($this->getAttribute($context["entity"], "user", array()), "contractType", array()), "name", array()) == "CDI"))) {
